...
| -- | ------------- | -------- | ------- | ------------------------------------------------------- | ---------- | -------------------------------------------------------- | ----------------------------------------------------- | ------------ |
| 11 | [terrastruct/d2](https://github.com/terrastruct/d2)       | [Go](https://github.com/EvanLi/Github-Ranking/blob/master/Top100/Go.md)       | 🐛 Bug Fix  | Migrate playwright-go to mxschmitt module path after deprecation; fix broken init-playwright | ⏳ Pending | [PR #2782](https://github.com/terrastruct/d2/pull/2782) | [Detail](contributions/terrastruct-d2-playwright-migration.md) | 25 Jul 2026 |
| 10 | [microsoft/playwright](https://github.com/microsoft/playwright) | [TypeScript](https://github.com/EvanLi/Github-Ranking/blob/master/Top100/TypeScript.md) | 🐛 Bug Fix  | Replace empty catch{} in ariaSnapshot with debugLogger; throw on fixture integrity violations | ❌ Closed | [PR #41502](https://github.com/microsoft/playwright/pull/41502) | [Detail](contributions/playwright-aria-fixture-error.md) | 27 Jun 2026 |
| 9  | [grafana/pyroscope](https://github.com/grafana/pyroscope)   | [Go](https://github.com/EvanLi/Github-Ranking/blob/master/Top100/Go.md) | ✨ Feature  | Add input validation for units and aggregationType in ingest handler — 72 tests | ❌ Closed | [PR #5293](https://github.com/grafana/pyroscope/pull/5293) | [Detail](contributions/pyroscope-ingest-validation.md) | 26 Jun 2026 |
