...
| -- | ------------- | -------- | ------- | ------------------------------------------------------- | ---------- | -------------------------------------------------------- | ----------------------------------------------------- | ------------ |
| 3  | [fern-api/fern](https://github.com/fern-api/fern)           | [TypeScript](https://github.com/EvanLi/Github-Ranking/blob/master/Top100/TypeScript.md) | 🐛 Bug Fix  | Report `anySignal()` race condition in TypeScript SDK generator | 📋 Reported | [Issue #16151](https://github.com/fern-api/fern/issues/16151) | [Detail](contributions/fern-api-fern.md) | 1 Jun 2026 |
