"""Convert README.md files to static HTML for the container image."""
import markdown
...
<title>FOSS Contributions — Muhammad Faisal Affan</title>
<style>{css}</style>
</head>
<body>
...
def convert(src_path, dst_path, label):
    ...
    body = WRAPPER.format(css=CSS, label=label, html=html)
...
if __name__ == "__main__":
    ...
    convert("README.id.md", "id.html",
            '<a href="/">🇬🇧 English</a>')
    print("Site generated: index.html, id.html")
